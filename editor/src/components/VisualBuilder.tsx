...
const DND_MIME = "application/x-akash-visual-layout-builder-widget";
...
export function VisualBuilder({
  ...
  return (
    <div
      className={`akash-visual-layout-builder-visual ${dragging ? "is-dragging" : ""}${railOpen ? "" : " is-rail-collapsed"}${inspectorOpen ? "" : " is-inspector-collapsed"}`}
    >
      <div className={`akash-visual-layout-builder-visual__side akash-visual-layout-builder-visual__side--left${railOpen ? "" : " is-collapsed"}`}>
        <aside className="akash-visual-layout-builder-visual__rail" aria-label="Elements" aria-hidden={!railOpen}>
        <div className="akash-visual-layout-builder-visual__panel-head">
          <h3>Elements</h3>
          <p className="akash-visual-layout-builder-visual__panel-sub">Add sections &amp; widgets</p>
        </div>

        <div className="akash-visual-layout-builder-visual__rail-block">
          <h4 className="akash-visual-layout-builder-visual__rail-label">Sections</h4>
          <div className="akash-visual-layout-builder-visual__preset-grid">
            {SECTION_PRESETS.map((preset) => (
              <button
                key={preset.label}
                type="button"
                className="akash-visual-layout-builder-visual__preset"
                onClick={() => handleAddSection(preset.columns)}
                title={`Add ${preset.label} section`}
              >
                <span className={`akash-visual-layout-builder-visual__preset-icon akash-visual-layout-builder-visual__preset-icon--${preset.columns}`} aria-hidden="true" />
                <span className="akash-visual-layout-builder-visual__preset-label">{preset.label}</span>
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="akash-visual-layout-builder-visual__rail-block">
          <h4 className="akash-visual-layout-builder-visual__rail-label">Widgets</h4>
          <p className="akash-visual-layout-builder-visual__hint">Drag onto the canvas, or click to add.</p>
          {WIDGET_CATEGORIES.map((category) => (
            <div key={category.id} className="akash-visual-layout-builder-visual__widget-cat">
              <h5 className="akash-visual-layout-builder-visual__widget-cat-title">{category.label}</h5>
              <div className="akash-visual-layout-builder-visual__widget-grid akash-visual-layout-builder-visual__widget-grid--tiles">
                {category.items.map((item) => (
                  <button
                    key={item.type}
                    type="button"
                    className="akash-visual-layout-builder-visual__widget-tile"
                  ...
                  >
                    <span className="akash-visual-layout-builder-visual__widget-tile-icon" aria-hidden="true">
                      {WIDGET_ICONS[item.type] || item.icon}
                    </span>
                    <span className="akash-visual-layout-builder-visual__widget-tile-label">{item.label}</span>
                  </button>
                ))}
              </div>
            </div>
      ...
      <div className="akash-visual-layout-builder-visual__canvas-wrap">
        <div className="akash-visual-layout-builder-visual__canvas-toolbar">
          <div className="akash-visual-layout-builder-visual__canvas-toolbar-left">
            <span className="akash-visual-layout-builder-visual__canvas-title">Canvas</span>
            {selection ? (
              <span className="akash-visual-layout-builder-visual__breadcrumb">
                <span className="akash-visual-layout-builder-visual__breadcrumb-sep">/</span>
                {selectionMeta.title}
              </span>
            ) : null}
          </div>
          <div className="akash-visual-layout-builder-visual__canvas-toolbar-right">
            {onDevicePreviewChange ? (
              <DeviceSwitcher value={devicePreview} onChange={onDevicePreviewChange} />
            ) : null}
            <span className={`akash-visual-layout-builder-visual__canvas-note ${dragging ? "is-live" : ""}`}>
              {dragging
        ...
        <div
          className={`akash-visual-layout-builder-visual__canvas akash-visual-layout-builder-visual__canvas--${devicePreview}${doc.sections.length === 0 ? " akash-visual-layout-builder-visual__canvas--blank" : ""}`}
          onClick={() => {
            setSelection(null);
            setShowStructurePicker(false);
          }}
        >
          <div
            className="akash-visual-layout-builder-visual__canvas-device"
            style={
              devicePreview === "desktop"
          ...
          >
          <div className="akash-visual-layout-builder-visual__page">
          {doc.sections.length === 0 ? (
            <div
              className="akash-visual-layout-builder-visual__empty"
              onDragOver={(e) => {
            ...
            >
              <div className="akash-visual-layout-builder-visual__empty-zone">
                <div className="akash-visual-layout-builder-visual__empty-actions-row">
                  <button
                    type="button"
                    className="akash-visual-layout-builder-visual__empty-circle akash-visual-layout-builder-visual__empty-circle--add"
                    title="Add section"
                    onClick={(e) => {
                      e.stopPropagation();
                ...
                {showStructurePicker ? (
                  <div className="akash-visual-layout-builder-visual__structure-picker">
                    <p className="akash-visual-layout-builder-visual__structure-picker-title">Select structure</p>
                    <div className="akash-visual-layout-builder-visual__structure-picker-grid">
                      {SECTION_PRESETS.map((preset) => (
                        <button
                          key={preset.label}
                          type="button"
                          className="akash-visual-layout-builder-visual__structure-preset"
                          title={`Add ${preset.label} section`}
                          onClick={(e) => {
                            e.stopPropagation();
                        ...
                        >
                          <span
                            className={`akash-visual-layout-builder-visual__preset-icon akash-visual-layout-builder-visual__preset-icon--${preset.columns}`}
                            aria-hidden="true"
                          />
                        </button>
                      ))}
                ...
                <p className="akash-visual-layout-builder-visual__empty-hint">Drag widget here</p>
              </div>
            </div>
          ) : (
            ...
            <div
              key={section.id}
              className={`akash-visual-layout-builder-visual-section ${selection?.kind === "section" && selection.sectionId === section.id ? "is-selected" : ""}`}
              style={{
            ...
            >
              <div className="akash-visual-layout-builder-visual-section__chrome">
                <StructureIcon kind="section" title={`Section ${sectionIndex + 1}`} />
                <div className="akash-visual-layout-builder-visual-section__actions">
                  <ChromeIconButton
                    title="Add column"
                    variant="add"
                    onClick={(e) => {
              ...
              <div
                className="akash-visual-layout-builder-visual-section__row"
                style={{
                  maxWidth:
                      ...
                      if (child.type === "inner-section") {
                        return (
                          <div key={child.id}>
                            ...
                            />
                            <div
                              className={`akash-visual-layout-builder-visual-inner ${
                            ...
                            >
                              <div className="akash-visual-layout-builder-visual-inner__chrome">
                                <StructureIcon kind="inner-section" title="Inner section" />
                                <div className="akash-visual-layout-builder-visual-inner__actions">
                                  <ChromeIconButton
                                    title="Add column"
                                    variant="add"
                                    onClick={(e) => {
                              ...
                              <div
                                className="akash-visual-layout-builder-visual-inner__row"
                                style={{
                                  gap: (() => {
          ...
          {doc.sections.length > 0 ? (
            <button
              type="button"
              className="akash-visual-layout-builder-visual__add-section"
              onClick={(e) => {
                e.stopPropagation();
                handleAddSection(1);
              }}
      ...
      <div className={`akash-visual-layout-builder-visual__side akash-visual-layout-builder-visual__side--right${inspectorOpen ? "" : " is-collapsed"}`}>
        <PanelSideToggle
          side="right"
          open={inspectorOpen}
        ...
        />
        <aside className="akash-visual-layout-builder-visual__inspector" aria-label="Settings" aria-hidden={!inspectorOpen}>
        <div className="akash-visual-layout-builder-visual__panel-head">
          <h3>{selectionMeta.title}</h3>
          {selectionMeta.subtitle ? <p className="akash-visual-layout-builder-visual__panel-sub">{selectionMeta.subtitle}</p> : null}
        </div>

        {!selection && (
          <div className="akash-visual-layout-builder-visual__empty-inspector">
            <div className="akash-visual-layout-builder-visual__empty-inspector-icon" aria-hidden="true">
              ✎
            </div>
            ...
            <p className="akash-visual-layout-builder-visual__empty-inspector-note">
        ...
        {selectedSection && selection?.kind === "section" && (() => {
          ...
          return (
          <div className="akash-visual-layout-builder-visual__fields">
            <ResponsiveDeviceBanner device={devicePreview} />
            <div className="akash-visual-layout-builder-visual__group">
              <h4 className="akash-visual-layout-builder-visual__group-title">Colors</h4>
              <ColorField
                label="Background"
            ...
            <div className="akash-visual-layout-builder-visual__group">
              <h4 className="akash-visual-layout-builder-visual__group-title">Layout</h4>
              <DimensionsField
                label="Padding"
            ...
            <div className="akash-visual-layout-builder-visual__group">
              <h4 className="akash-visual-layout-builder-visual__group-title">Background image</h4>
              <Field label="Image">
                <ImageMediaControl
            ...
            {devicePreview !== "desktop" && (
              <button
                type="button"
                className="akash-visual-layout-builder-visual__reset-btn"
                onClick={() =>
        ...
        {selection?.kind === "column" && (() => {
          ...
          <div className="akash-visual-layout-builder-visual__fields">
            <ResponsiveDeviceBanner device={devicePreview} />
            <div className="akash-visual-layout-builder-visual__group">
              <h4 className="akash-visual-layout-builder-visual__group-title">Column</h4>
              <label>
                Width (%)
                <input
                  type="number"
        ...
        {selection?.kind === "inner-section" && (
          <div className="akash-visual-layout-builder-visual__fields">
            <p className="akash-visual-layout-builder-visual__panel-sub">Select an inner column or widget inside this nested section to edit it.</p>
            <InspectorDeleteButton
        ...
        {selectedWidget && selection?.kind === "widget" && (
          <>
            <div className="akash-visual-layout-builder-visual__tabs" role="tablist">
              <button
                type="button"
                role="tab"
...
function PanelSideToggle({
  ...
  return (
    <button
      type="button"
      className={`akash-visual-layout-builder-visual__side-toggle akash-visual-layout-builder-visual__side-toggle--${side}`}
      onClick={onToggle}
      aria-label={label}
      aria-expanded={open}
      title={label}
...
function EmptyColumnDropHint() {
  return (
    <div className="akash-visual-layout-builder-visual-column__empty">
      <span className="akash-visual-layout-builder-visual-column__empty-plus" aria-hidden="true">
        +
      </span>
      <span className="akash-visual-layout-builder-visual-column__empty-hint">Drag widget here</span>
    </div>
  );
}
...
function InspectorDeleteButton({ label, onDelete }: { label: string; onDelete: () => void }) {
  return (
    <div className="akash-visual-layout-builder-visual__inspector-delete">
      <button type="button" className="akash-visual-layout-builder-visual__inspector-delete-btn" onClick={onDelete}>
        {label}
      </button>
    </div>
  );
...
function ChromeIconButton({
  ...
  return (
    <button
      type="button"
      className={`akash-visual-layout-builder-visual__chrome-btn akash-visual-layout-builder-visual__chrome-btn--${variant}`}
      title={title}
      aria-label={title}
      onClick={onClick}
    >
...
function ColumnDropZone({
  ...
  return (
    <div
      className={`akash-visual-layout-builder-visual-column ${selected ? "is-selected" : ""} ${isDropTarget ? "is-drop-target" : ""}`}
      style={style}
      onClick={(e) => {
        e.stopPropagation();
        onSelect();
    ...
    >
      <div className="akash-visual-layout-builder-visual-column__chrome">
        <StructureIcon kind={structureKind} title={label} />
        <div className="akash-visual-layout-builder-visual-column__actions">
          {chromeExtra}
          {onRemove ? (
            <ChromeRemoveButton
              title="Remove column"
...
function DropSlot({
  ...
  return (
    <div
      className={`akash-visual-layout-builder-visual-drop ${active ? "is-active" : ""}`}
      onDragEnter={(e) => {
        e.preventDefault();
        setDropKey(slotKey);
      }}
...
function ResponsiveDeviceBanner({ device }: { device: DevicePreview }) {
  ...
  return (
    <div className="akash-visual-layout-builder-visual__device-banner">
...
function ColorField({
  ...
  return (
    <Field label={label}>
      <div className="akash-visual-layout-builder-visual__color-control">
        <div className="akash-visual-layout-builder-visual__color-row">
          <input
            type="color"
            value={parsed.hex}
          ...
          <input
            type="text"
            className="akash-visual-layout-builder-visual__hex-input"
            value={hexText}
            placeholder="#000000"
            spellCheck={false}
            onChange={(e) => {
          ...
          />
          {allowClear ? (
            <button type="button" className="akash-visual-layout-builder-visual__link-btn" onClick={() => onChange("transparent")}>
              Clear
            </button>
          ) : null}
        </div>
        <div className="akash-visual-layout-builder-visual__opacity-row">
          <label className="akash-visual-layout-builder-visual__opacity-label" htmlFor={`akash-visual-layout-builder-opacity-${label.replace(/\s+/g, "-").toLowerCase()}`}>
            Opacity
          </label>
          <input
            id={`akash-visual-layout-builder-opacity-${label.replace(/\s+/g, "-").toLowerCase()}`}
            type="range"
            min={0}
            max={100}
            step={1}
          ...
          <input
            type="number"
            className="akash-visual-layout-builder-visual__opacity-input"
            min={0}
            max={100}
            value={parsed.alpha}
          ...
          />
          <span className="akash-visual-layout-builder-visual__opacity-unit">%</span>
        </div>
      </div>
    </Field>
  );
...
function SizeField({
  ...
  return (
    <Field label={label}>
      <div className="akash-visual-layout-builder-visual__size-control">
        <input
          type="number"
          className="akash-visual-layout-builder-visual__size-input"
          value={parsed.num}
        ...
        />
        <select
          className="akash-visual-layout-builder-visual__unit-select"
          value={unit}
...
function DimensionsField({
  ...
  return (
    <div className="akash-visual-layout-builder-visual__dimensions">
      <div className="akash-visual-layout-builder-visual__dimensions-head">
        <span className="akash-visual-layout-builder-visual__dimensions-label">{label}</span>
        <div className="akash-visual-layout-builder-visual__dimensions-units" role="group" aria-label={`${label} units`}>
          {DIMENSION_UNITS.map((u) => (
            <button
              key={u}
              type="button"
              className={`akash-visual-layout-builder-visual__dimensions-unit ${unit === u ? "is-active" : ""}`}
              onClick={() => setUnit(u)}
            >
              {u}
            </button>
      ...
      <div className="akash-visual-layout-builder-visual__dimensions-row">
        {(["top", "right", "bottom", "left"] as BoxSideKey[]).map((side) => (
          <label key={side} className="akash-visual-layout-builder-visual__dimensions-cell">
            <input
              type="number"
              value={nums[side]}
              placeholder="0"
        ...
        <button
          type="button"
          className={`akash-visual-layout-builder-visual__dimensions-link ${linked ? "is-active" : ""}`}
...
function ensureVisualEditorFonts() {
  ...
  if (!window.akashVisualLayoutBuilderData?.pluginSettings?.google_fonts_enabled) return;
  if (document.getElementById("akash-visual-layout-builder-visual-fonts")) return;
  const link = document.createElement("link");
  link.id = "akash-visual-layout-builder-visual-fonts";
  link.rel = "stylesheet";
...
function WidgetCard({
  ...
  return (
    <div
      className={`akash-visual-layout-builder-visual-widget ${selected ? "is-selected" : ""}`}
      draggable
      onDragStart={(e) => {
        e.stopPropagation();
        onDragStart(e);
    ...
    >
      <div className="akash-visual-layout-builder-visual-widget__chrome">
        <span className="akash-visual-layout-builder-visual-widget__drag" title="Drag to move" aria-hidden="true">
          ⋮⋮
        </span>
        <span className="akash-visual-layout-builder-visual-widget__type" title={widgetLabel(widget.type)}>
          <span className="akash-visual-layout-builder-visual-widget__type-icon" aria-hidden="true">
      ...
      <div className="akash-visual-layout-builder-visual-widget__preview" style={previewStyle(widget, devicePreview)}>
...
function renderWidgetPreview(widget: VisualWidget, pageId = 0) {
  switch (widget.type) {
    ...
    case "html":
      return <p className="akash-visual-layout-builder-visual-widget__preview-text">{widget.content.replace(/<[^>]+>/g, " ").slice(0, 180)}</p>;
    case "posts-grid":
    case "posts-list":
    case "posts-carousel":
...
function ImageMediaControl({
  ...
  return (
    <div className="akash-visual-layout-builder-visual-media">
      {url ? (
        <div className="akash-visual-layout-builder-visual-media__preview">
          <img src={url} alt="" />
          <div className="akash-visual-layout-builder-visual-media__toolbar">
        ...
        <button type="button" className="akash-visual-layout-builder-visual-media__empty" onClick={pick}>
          <span aria-hidden="true">+</span>
          Choose image
        </button>
      )}
      <div className="akash-visual-layout-builder-visual-media__actions">
        {url ? (
          <button type="button" className="akash-visual-layout-builder-visual__link-btn" onClick={pick}>
            Choose from library
          </button>
        ) : null}
        <button type="button" className="akash-visual-layout-builder-visual__link-btn" onClick={() => setShowUrl((v) => !v)}>
    ...
    <div className="akash-visual-layout-builder-visual__fields">
      ...
      {widget.type === "button" && (
        <>
          ...
          <div className="akash-visual-layout-builder-visual__field-row">
            <SizeField
              label="Padding X"
...
function WidgetLinkFields({
  ...
  return (
    <div className="akash-visual-layout-builder-visual__group">
      <h4 className="akash-visual-layout-builder-visual__group-title">Link</h4>
      <Field label="URL">
        <UrlSuggestField
      ...
      <p className="akash-visual-layout-builder-visual__hint">Optional. Makes the whole widget clickable.</p>
      <label className="akash-visual-layout-builder-visual__check">
        <input
          type="checkbox"
...
function WidgetStyleSettings({
  ...
  return (
    <div className="akash-visual-layout-builder-visual__fields">
      <ResponsiveDeviceBanner device={devicePreview} />
      <div className="akash-visual-layout-builder-visual__group">
        <h4 className="akash-visual-layout-builder-visual__group-title">Spacing</h4>
        <DimensionsField
          label="Margin"
          values={{
            top: style.marginTop,
      ...
      <div className="akash-visual-layout-builder-visual__group">
        <h4 className="akash-visual-layout-builder-visual__group-title">Typography</h4>
      ...
      <div className="akash-visual-layout-builder-visual__group">
        <h4 className="akash-visual-layout-builder-visual__group-title">Size & background</h4>
        <SizeField
          label="Max width"
      ...
      <div className="akash-visual-layout-builder-visual__group">
        <h4 className="akash-visual-layout-builder-visual__group-title">Border</h4>
        <div className="akash-visual-layout-builder-visual__field-row">
      ...
      <div className="akash-visual-layout-builder-visual__group">
        <h4 className="akash-visual-layout-builder-visual__group-title">Effects</h4>
