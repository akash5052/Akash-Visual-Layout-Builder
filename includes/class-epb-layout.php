...
class EPB_Layout {
	...
	const OPTION_GLOBAL = 'epb_global_layout';
	const META_PAGE     = '_epb_page_layout';
	...
	private static function wrap_region($region, $scope, $html) {
		...
		return '<div class="epb-region epb-region--' . esc_attr($region) . ' epb-region--' . esc_attr($scope) . '" data-epb-region="' . esc_attr($region) . '">' . EPB_Output::kses_html($html) . '</div>';
	}
