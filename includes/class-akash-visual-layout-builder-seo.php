 ...
 */
class Akash_Visual_Layout_Builder_SEO {

	const META_KEY = '_akash_visual_layout_builder_seo';
	...
	/**
	 * Whether post is an Akash Visual Layout Builder page with SEO output enabled.
	 *
	 * @param int|null $post_id Post ID.
	 * @return int|false
	 */
	private function get_akash_visual_layout_builder_post_id($post_id = null) {
		if ($post_id === null) {
	...
	/**
	 * Filter document title for Akash Visual Layout Builder pages.
	 *
	 * @param string $title Current title.
	 * @return string
	 */
	public function filter_document_title($title) {
		$post_id = $this->get_akash_visual_layout_builder_post_id();
		if (!$post_id) {
			return $title;
		}
