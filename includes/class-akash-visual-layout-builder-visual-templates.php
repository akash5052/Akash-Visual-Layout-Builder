 ...
 */
class Akash_Visual_Layout_Builder_Visual_Templates {
	...
	public static function get($id) {
		...
		$code   = Akash_Visual_Layout_Builder_Visual_Compile::compile($visual);
	...
	private static function uid($prefix = 'akash-visual-layout-builder') {
	...
	private static function site_footer($brand, $accent, $blurb, $cols = [], $bg = '#0f172a', $color = '#ffffff', $muted = 'rgba(255,255,255,.72)', $font = 'Outfit') {
		...
		$legal = self::section(
			[ self::column(100, [
				...
				self::text('© ' . gmdate('Y') . ' ' . $brand . ' · Built with Akash Visual Layout Builder · All content is editable', 'center', $muted, [
